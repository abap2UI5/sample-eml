CLASS z2ui5_cl_smpe_app_484 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smpe_app_484 IMPLEMENTATION.
    ...
    IF client->check_on_init( ).
      ...
      page->message_strip(
          text     = `RECEIVER side of launchpad cross-app navigation: started via the sender ` &&
                     `tile (z2ui5_cl_smpe_app_483), it reads the Product and Quantity values the ` &&
