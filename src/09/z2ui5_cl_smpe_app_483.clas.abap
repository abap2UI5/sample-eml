CLASS z2ui5_cl_smpe_app_483 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smpe_app_483 IMPLEMENTATION.
    ...
    IF client->check_on_init( ).
      ...
      page->message_strip(
          text     = `SENDER side of launchpad cross-app navigation: the button navigates to ` &&
                     ...
                     `parameters - the receiver (z2ui5_cl_smpe_app_484) reads them from its ` &&
                     `startup parameters. ` &&
