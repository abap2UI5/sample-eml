CLASS zcl_lk22_ui5_evtlog DEFINITION PUBLIC CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_s_log,
        event_name TYPE zlk22_event_name,
        log_text   TYPE zlk22_log_text,
...
CLASS zcl_lk22_ui5_evtlog IMPLEMENTATION.
