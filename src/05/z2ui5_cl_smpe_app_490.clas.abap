CLASS z2ui5_cl_smpe_app_490 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smpe_app_490 IMPLEMENTATION.
      ...
      TRY.
          ...
          CASE client->get( )-event.
            WHEN `CALL_BOOKING_MASK`.
              ...
              DATA(lr_view2) = NEW z2ui5_cl_smpe_app_490( ).
              lr_view2->view_id = 2.
              lr_view2->varkey = `001`.
    ...
    ELSEIF view_id = 2.
      TRY.
          ...
          CASE client->get( )-event.
            WHEN `NEXT_LOCK`.
              client->set_session_stateful( abap_false ).
              lr_view2 = NEW z2ui5_cl_smpe_app_490( ).
              lr_view2->view_id = 2.
