CLASS z2ui5_cl_smpe_app_489 DEFINITION PUBLIC.
...
CLASS z2ui5_cl_smpe_app_489 IMPLEMENTATION.
  ...
  METHOD on_init.
    ...
    connections = z2ui5_cl_smpe_app_489_ws=>get_active_connections( ).
    ws_active   = abap_true.
    ws_status   = `Connected`.
  ...
  METHOD on_event_post.
    ...
    TRY.
        ...
        z2ui5_cl_smpe_app_489_ws=>send( z2ui5_cl_ajson=>create_empty(
            )->set(
                iv_path         = `/`
                iv_val          = s_news
  ...
  METHOD on_event_received.
    ...
    CASE ws_message.
      WHEN z2ui5_cl_smpe_app_489_ws=>c_msg-__new_connection__.
        connections = connections + 1.

      WHEN z2ui5_cl_smpe_app_489_ws=>c_msg-__closed__.
        connections = connections - 1.
